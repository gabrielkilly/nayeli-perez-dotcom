            ...
            <div className="w-full flex-col border-2 border-t-border-subtle">
                ...
                >
                    <div className="flex w-full flex-col items-center justify-center">
                        <div className={`text-icon-plum text-4xl font-normal ${fontYarndings12.className}`}>q</div>
                        <p className={`self-stretch text-center justify-start text-type-2 text-2xl font-normal ${fontLora.className} leading-loose`}>
